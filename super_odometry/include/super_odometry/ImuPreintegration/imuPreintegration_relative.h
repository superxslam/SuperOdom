//
// Header for Pure Relative Pose Graph Implementation
//
#pragma once
...
namespace super_odometry {
    ...
    public:
        ...
        // Modified for relative pose graph - includes world pose parameter
    ...
    public:
        ...
        // Graph nodes store relative poses
        ...
        // Lidar odometry poses
        gtsam::Pose3 lidarodom_w_pre;
        gtsam::Pose3 lidarodom_w_cur;
        
        // World pose tracking (outside of graph)
